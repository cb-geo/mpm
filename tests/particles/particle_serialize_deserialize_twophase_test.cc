...
//         MPI_Send(&h5_particle, 1, particle_type, receiver, 0,
//         MPI_COMM_WORLD); mpm::deregister_mpi_particle_type(particle_type);
//       }
...
//         MPI_Datatype particle_type =
//         mpm::register_mpi_particle_type(received); MPI_Recv(&received, 1,
...
//         REQUIRE(h5_particle.nliquid_state_vars ==
//         received.nliquid_state_vars); for (unsigned i = 0; i <
//         h5_particle.nliquid_state_vars; ++i)
...
//         REQUIRE(particle->initialise_particle(h5_particle, materials) ==
//         true);
...
//         // State variables
//         REQUIRE(h5_twophase_received->nstate_vars ==
//         h5_particle.nstate_vars);
//         // State variables
//         for (unsigned i = 0; i < h5_particle.nstate_vars; ++i)
