...
TEST_CASE("NorSand is checked in 3D non-bonded model",
  ...
  SECTION("NorSand check undrained stresses after yielding with bonded model") {
    ...
    // Check stresses
    REQUIRE(stress(0) == Approx(-3.13993610411441E+05).epsilon(Tolerance));
    REQUIRE(stress(1) == Approx(-1.43109978643817E+05).epsilon(Tolerance));
    REQUIRE(stress(2) == Approx(-1.43109978643817E+05).epsilon(Tolerance));
    REQUIRE(stress(3) == Approx(0.000000).epsilon(Tolerance));
    REQUIRE(stress(4) == Approx(0.000000).epsilon(Tolerance));
    REQUIRE(stress(5) == Approx(0.000000).epsilon(Tolerance));
    ...
    REQUIRE(state_vars.at("e_image") ==
            Approx(0.7973104329).epsilon(Tolerance));
    REQUIRE(state_vars.at("p_image") ==
            Approx(152458.994391419).epsilon(Tolerance));
    ...
    REQUIRE(state_vars.at("pdstrain") ==
            Approx(0.0099933008).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain0") ==
            Approx(0.0099913768).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain1") ==
            Approx(-0.0049985745).epsilon(Tolerance));
...
TEST_CASE("NorSand is checked in 3D bonded model", "[material][NorSand][3D]") {
  ...
  SECTION("NorSand check undrained stresses after yielding with bonded model") {
    ...
    // Check stresses
    REQUIRE(stress(0) == Approx(-3.16925194116081E+05).epsilon(Tolerance));
    REQUIRE(stress(1) == Approx(-1.41713163708184E+05).epsilon(Tolerance));
    REQUIRE(stress(2) == Approx(-1.41713163708184E+05).epsilon(Tolerance));
    REQUIRE(stress(3) == Approx(0.000000).epsilon(Tolerance));
    REQUIRE(stress(4) == Approx(0.000000).epsilon(Tolerance));
    REQUIRE(stress(5) == Approx(0.000000).epsilon(Tolerance));
    ...
    REQUIRE(state_vars.at("void_ratio") ==
            Approx(jmaterial["void_ratio_initial"]).epsilon(Tolerance));
    REQUIRE(state_vars.at("e_image") == Approx(0.815002999).epsilon(Tolerance));
    REQUIRE(state_vars.at("p_image") ==
            Approx(127736.5589113801).epsilon(Tolerance));
    REQUIRE(state_vars.at("p_cohesion") ==
            Approx(8.1900128820951E+03).epsilon(Tolerance));
    REQUIRE(state_vars.at("p_dilation") ==
            Approx(1.9026159880212E+04).epsilon(Tolerance));
    REQUIRE(state_vars.at("pdstrain") ==
            Approx(0.009983481).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain0") ==
            Approx(0.009980390).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain1") ==
            Approx(-0.004994832).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain2") ==
            Approx(-0.004994832).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain3") == Approx(0.0).epsilon(Tolerance));
    REQUIRE(state_vars.at("plastic_strain4") == Approx(0.0).epsilon(Tolerance));
